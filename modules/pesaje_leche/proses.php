...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO peso_leche(id,id_animal,id_empleado,fecha,peso_am,peso_pm,peso)  
                                            VALUES('$id','$id_animal','$id_empleado','$fecha','$peso_am','$peso_pm','$peso_am')")
