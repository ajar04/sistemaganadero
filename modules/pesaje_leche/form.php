          ...
          <!-- form start -->
              <form role="form" class="form-horizontal" action="modules/pesaje_leche/proses.php?act=insert" method="POST">
                <div class="box-body">
                 ...
                 <div class="form-group">
                    <label class="col-sm-2 col-form-label">Peso mañana</label>
                    <div class="col-sm-3">
                      <div class="input-group">
                        <span class="input-group-addon">Kg.</span>
                        <input type="text" class="form-control" id="peso" name="peso_am" autocomplete="off" onKeyPress="return goodchars(event,'0123456789.',this)" required>
                      </div>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-2 col-form-label">Peso tarde</label>
                    <div class="col-sm-3">
                      <div class="input-group">
                        <span class="input-group-addon">Kg.</span>
                        <input type="text" class="form-control" id="peso" name="peso_pm" autocomplete="off" onKeyPress="return goodchars(event,'0123456789.',this)" required>
                      </div>
                    </div>
                  </div>
